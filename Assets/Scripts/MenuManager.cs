...
public class MenuManager : MonoBehaviour
{
    ...
    public DifficultySelector difficultySelector; // Add reference to difficulty selector
    ...
    public void StartGame()
    {
        ...
        {
            GameDifficulty selectedDifficulty = difficultySelector.GetSelectedDifficulty();
            PlayerPrefs.SetInt("GameDifficulty", (int)selectedDifficulty);
            Debug.Log($"Saved difficulty: {selectedDifficulty}");
        }
